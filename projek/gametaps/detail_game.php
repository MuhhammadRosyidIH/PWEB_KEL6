            ...
            <div class="card-body">
                ...
                <div class="d-flex">
                    <form action="" method="POST">
                        ...
                        <button class="btn btn-success" style="margin-left: 20px;" type="submit" name="download" onclick="return alert('Mohon login terlebih dahulu untuk mendownload!');"><i class="bi bi-download me-2"></i>Link Download</button>
                    </form>
                </div>
            </div>
        </div>
